        ...
        <div class="col-md-3">
            ...
            <div>
                ...
                <a href="http://twitter.com">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-twitter-x mx-2" viewBox="0 0 16 16">
            ...
            <div class="col-6" style="display: flex; margin-left: -30px;">
